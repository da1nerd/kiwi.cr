module Kiwi::Strength
  ...
  protected def create(a : Float64, b : Float64, c : Float64, w : Float64) : Float64
    result = 0.0
  ...
  protected def create(a : Float64, b : Float64, c : Float64) : Float64
    create(a, b, c, 1.0)
  end

  protected def clip(value : Float64) : Float64
